...
media_pessoas_treinam <- 3.20
list(
  icon = 'fuel-pump',
  color = 'green3',
  value = media_pessoas_treinam
)
```

### Column {width='200px'}
```{r}
#| title: Não pratica exercícios
#| content: valuebox
dados_1 <- dados |> 
  drop_na(exercicios) |> 
  group_by(exercicios) |> 
...
media_pessoas_nao_treinam <- 2.8
list(
  icon = 'fuel-pump',
  color = 'red4',
  value = media_pessoas_nao_treinam
  )
```
